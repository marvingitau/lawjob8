    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="row">
            <div class="col-sm-7">
              <img class="img-fluid mb-sm-0 w-100" src="images/about/01.png" alt="">
            </div>
        ...
        <div class="col-lg-6 align-self-center">
          <div class="section-title-02">
            ...
            <p>I truly believe Augustine’s words are true and if you look at history you know it is true. There are many people in the world with amazing talents who realize only a small percentage of their potential. </p>
          </div>
          <div class="row mt-sm-5 mt-4">
            <div class="col-md-6">
              <div class="d-flex mb-lg-5 mb-4">
                <i class="font-xlll text-primary  fas fa-users"></i>
                <h5 class="ps-3 align-self-center mb-0">Best talented people</h5>
              </div>
            </div>
            <div class="col-md-6">
              <div class="d-flex mb-lg-5 mb-4">
                <i class="font-xlll text-primary fab fa-rocketchat"></i>
                <h5 class="ps-3 align-self-center mb-0">Easy to find candidate</h5>
              </div>
            </div>
            <div class="col-md-6">
              <div class="d-flex mb-md-0 mb-4">
                <i class="font-xlll text-primary fas fa-user-clock"></i>
                <h5 class="ps-3 align-self-center mb-0">Easy to communicate</h5>
              </div>
            </div>
            <div class="col-md-6">
              <div class="d-flex">
                <i class="font-xlll text-primary fas fa-globe-africa"></i>
      ...
      <div class="row">
        <div class="col-lg-6 mb-lg-0 mb-4">
          <div class="feature-info feature-info-02 p-4 p-lg-5 bg-primary">
            ...
            <a class="ms-auto align-self-center" href="{{url('/joblist')}}">Apply now<i class="fas fa-long-arrow-alt-right"></i> </a>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="feature-info feature-info-02 p-4 p-lg-5 bg-dark">
            ...
            <a class="ms-auto align-self-center" href="{{ url('/register') }}">Post a job<i class="fas fa-long-arrow-alt-right"></i> </a>
          </div>
        </div>
      </div>
    </div>
